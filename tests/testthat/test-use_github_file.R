...
test_that("parse_file_url() errors when it should", {
  expect_acwri_error(parse_file_url("https://github.com/OWNER/REPO"))
  expect_acwri_error(parse_file_url("https://github.com/OWNER/REPO.git"))
  expect_acwri_error(parse_file_url(
