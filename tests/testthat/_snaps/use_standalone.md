# standalone_header() works with various inputs
    ...
    Output
      ...
      [3] "# Generated by: acwri::use_standalone(\"OWNER/REPO\", \"foo\")"          
      [4] "# ----------------------------------------------------------------------"
      [5] "#"                                                                       
...
---
    ...
    Output
      ...
      [3] "# Generated by: acwri::use_standalone(\"OWNER/REPO\", \"foo\", ref = \"blah\")"
      [4] "# ----------------------------------------------------------------------"      
      [5] "#"                                                                             
...
---
    ...
    Output
      ...
      [3] "# Generated by: acwri::use_standalone(\"OWNER/REPO\", \"foo\", host = \"https://github.acme.com\")"
      [4] "# ----------------------------------------------------------------------"                          
      [5] "#"                                                                                                 
...
---
    ...
    Output
      ...
      [3] "# Generated by: acwri::use_standalone(\"OWNER/REPO\", \"foo\", ref = \"blah\", host = \"https://github.acme.com\")"
      [4] "# ----------------------------------------------------------------------"                                          
      [5] "#"                                                                                                                 
