...
test_that("use_dependency() upgrades a dependency", {
  ...
  expect_snapshot(use_dependency("acwri", "Suggests"))
  expect_match(desc::desc_get("Suggests"), "acwri")

  expect_snapshot(use_dependency("acwri", "Imports"))
  expect_match(desc::desc_get("Imports"), "acwri")
