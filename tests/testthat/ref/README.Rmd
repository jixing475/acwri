...
acwri has an unexported function `tidy_unzip()`, which is used under the hood in `use_course()` and `use_zip()`.
...
This is the type of ZIP file that we get from GitHub via links of the forms <https://github.com/jixing475/acwri/archive/main.zip> and <http://github.com/jixing475/acwri/zipball/main/>.
...
This type of ZIP file was reported in <https://github.com/jixing475/acwri/issues/1961>.
