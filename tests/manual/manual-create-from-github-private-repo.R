...
dir_delete(path(acwri:::conspicuous_place(), repo_name))
expect_false(dir_exists(path(acwri:::conspicuous_place(), repo_name)))

# create the repo
gh::gh(
  "POST /user/repos",
  name = repo_name,
  description = "acwri manual test repo",
