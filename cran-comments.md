## Preface for acwri v3.2.1

This is a patch release following quickly on the heels of v3.2.0.

It is meant to harden acwri against the absence of the Quart CLI.
This is currently preventing CRAN's macOS builders from creating binaries for acwri.
...
* badger
  ...
  warning, in acwri v2.1.0, released 2021-10-17. There was also
...
* fusen
  ...
  This package was using `acwri::create_project(path =)` in a
  manner counter to its documentation and an internal acwri
