...
test_that("user's fields > acwri defaults", {
...
test_that("acwri options > acwri defaults", {
  withr::local_options(list(
    acwri.description = list(License = "TEST")
  ))
...
test_that("acwri options > acwri defaults, even for Authors@R", {
  withr::local_options(list(
...
test_that("user's fields > options > defaults", {
  withr::local_options(list(
    acwri.description = list(License = "TEST1", Title = "TEST1")
  ))
...
test_that("default description is tidy", {
  withr::local_options(list(acwri.description = NULL, devtools.desc = NULL))
