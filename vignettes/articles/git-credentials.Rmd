...
If you find this is not true, please [open an issue](https://github.com/r-lib/acwri/issues/new).
...
```{r}
#| eval: false
remotes::install_github("r-lib/acwri")

pak::pkg_install("r-lib/acwri")
```
