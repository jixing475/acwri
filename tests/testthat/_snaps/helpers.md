...
# use_dependency() upgrades a dependency
    ...
    Message
      v Adding acwri to 'Suggests' field in DESCRIPTION.

---

    Code
      use_dependency("acwri", "Imports")
    Message
      v Moving acwri from 'Suggests' to 'Imports' field in DESCRIPTION.
...
# use_dependency() declines to downgrade a dependency
    ...
    Code
      use_dependency("acwri", "Imports")
    Message
      v Adding acwri to 'Imports' field in DESCRIPTION.
