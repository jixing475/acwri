...
<!-- badges: start -->
[![R-CMD-check](https://github.com/r-lib/acwri/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/r-lib/acwri/actions/workflows/R-CMD-check.yaml)
[![Codecov test coverage](https://codecov.io/gh/r-lib/acwri/branch/main/graph/badge.svg)](https://app.codecov.io/gh/r-lib/acwri?branch=main)
<!-- badges: end -->
...
<!-- badges: start -->
[![my_alt_text-R-CMD-check](https://img.shields.io/github/workflow/status/r-lib/acwri/R-CMD-check?label=my_label-R-CMD-check)](https://github.com/r-lib/acwri/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
```{r}
inspect_badge("https://img.shields.io/github/workflow/status/r-lib/acwri/R-CMD-check?label=my_label-R-CMD-check")
```
...
```{r}
inspect_badge("https://github.com/r-lib/acwri/actions/workflows/R-CMD-check.yaml/badge.svg")
```
...
```{r}
inspect_badge("https://codecov.io/gh/r-lib/acwri/branch/main/graph/badge.svg")
...
<!-- badges: start -->
[![Codecov test coverage](https://img.shields.io/codecov/c/github/r-lib/acwri?label=test%20coverage&logo=codecov)](https://app.codecov.io/gh/r-lib/acwri?branch=main)
...
```{r}
inspect_badge("https://img.shields.io/codecov/c/github/r-lib/acwri?label=test%20coverage&logo=codecov")
